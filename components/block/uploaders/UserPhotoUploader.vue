...
<template>
  <div class="text-[var(--ui-text-main)]">
    <div class="flex items-center gap-4">
      <div
        v-if="previewUrl"
        class="relative w-[80px] h-[80px] rounded-full bg-[var(--ui-background)] border border-[var(--color-stroke-ui-dark)] overflow-hidden">
      ...
      <div
        v-else
        class="relative w-[80px] h-[80px] rounded-full bg-[var(--ui-background)] border border-[var(--color-stroke-ui-dark)] flex items-center justify-center group cursor-pointer"
        @click="clickSelectionFile">
      ...
      <div class="flex flex-col gap-2">
        ...
        <div
          v-if="loading"
          class="h-1.5 bg-[var(--ui-primary-main-defalt)] rounded-md overflow-hidden">
          <div
        ...
        <UiTextSmall>
          {{ t("cabinet.profile.components.tab-user-photo.hints.formats") }} ·
          {{ t("cabinet.profile.components.tab-user-photo.hints.maxSize") }}
        </UiTextSmall>
      </div>
    </div>
  </div>
