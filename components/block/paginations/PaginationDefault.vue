<template>
  <div class="pagination">
    ...
    <div
      class="pagination__items pagination__column"
      v-if="!isLoading">
      <div
        v-if="totalPages > 1"
      ...
      <div
        v-else
        class="pagination__item-dot">
        •
      </div>
    </div>
    <div
      class="pagination__column pagination__column-right"
      v-if="!isLoading">
      {{ t("ui.pagination.range", { from: currentStartRow, to: currentEndRow, total: totalRows }) }}
    </div>
  </div>
</template>
