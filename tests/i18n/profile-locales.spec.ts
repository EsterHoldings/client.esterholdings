...
describe("profile locale coverage", () => {
  ...
  it("contains localized copy for profile documents, security, photo and verification flows", () => {
    const requiredKeys = [
      ...
      "cabinet.profile.components.tab-general.buttons.edit",
      "cabinet.profile.components.tab-general.buttons.update",
      "cabinet.profile.components.tab-general.documentsReminder.title",
      "cabinet.profile.components.tab-general.documentsReminder.text",
      "cabinet.profile.components.tab-general.documentsReminder.button",
      ...
      "cabinet.profile.components.tab-user-documents.info.title",
      "cabinet.profile.components.tab-user-documents.info.text",
      "cabinet.profile.components.tab-user-documents.dropzone.title",
      "cabinet.profile.components.tab-user-documents.dropzone.separator",
      "cabinet.profile.components.tab-user-documents.dropzone.action",
      "cabinet.profile.components.tab-user-documents.dropzone.hint",
      "cabinet.profile.components.tab-user-documents.dropzone.disabledHint",
      ...
      "cabinet.profile.components.tab-user-verification.adminCommentLabel",
