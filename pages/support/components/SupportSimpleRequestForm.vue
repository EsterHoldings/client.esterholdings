<template>
  <div class="support-simple grid gap-2 lg:grid-cols-[minmax(0,1.12fr)_minmax(320px,0.88fr)]">
    <section class="support-simple__form-column rounded-2xl bg-[var(--ui-background-panel)] p-5 md:p-6">
    ...
    <section class="support-simple__history rounded-2xl bg-[var(--ui-background-panel)] p-5 md:p-6">
